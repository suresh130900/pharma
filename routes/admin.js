...
router.post('/medicine/create', function (req, res) {
    ...
    req.getValidationResult().then(function (result) {
        ...
        if (!result.isEmpty()) {
            ...
            console.log("inserting into medicine");
            console.log(medicine);
            var query_insert = "insert into medicine_information SET ?";
            db.getData(query_insert, [medicine], function(rows) {
                console.log(rows);
